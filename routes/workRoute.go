...
func WorkRoute() string {
	response, err := http.Get("https://www.mvg.de/api//fahrinfo/departure/de:09162:700?footway=0")
	...
	for _, d := range data["departures"] {
		if d.Label == destinations.WorkDestinaion.Label && d.Destination == destinations.WorkDestinaion.Destination {
